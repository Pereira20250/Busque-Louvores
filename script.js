const louvores = [
  {
    cantor: "Matheus Amorim Pereira",
    nome: "Tu És Minha Vida",
    cifra: `🎵 Tu És Minha Vida (Tom: C)
...
G
Quem me ensina és Tu
Am
Contigo eu aprendo a viver
F
E a entender o Teu amor

C
Tu és santo, meu Deus
G
...
C
Vem guiar minha vida
G
Me ensina a viver
Am
Nos Teus santos propósitos
F
Quero mais de Ti conhecer

[Verso 2]
C
Eu quero o Senhor na minha vida
G
...
C
Me ensina mais de Ti
G
Quero mais do Teu querer
Am
Espírito Santo me guia
F
Pra sempre Te obedecer
...
Vem me transformar
F
Pra que em todo tempo
G
Eu viva pra Te adorar
...
Eu tento disfarçar
G
Mas gosto de você assim

[Refrão]
C
Eu gosto de você
G
Mais do que eu planejei
Am
Foi chegando de mansinho
F
Quando eu nem percebi, me apaixonei
...
[Verso 2]
C
Guardo cada conversa
G
Cada momento teu
Am
Nos detalhes mais simples
F
Meu sentimento cresceu

C
Não é coisa de momento
G
Nem vontade que vai passar
Am
Quando eu penso no futuro
F
É você que eu consigo enxergar
...
E segure a minha mão`
  ...
  {
    cantor: "Matheus Amorim Pereira",
    nome: "Meu Coração é Teu",
    cifra: `🎵 Meu Coração é Teu (Tom: C)

[Verso 1]
C
Teu amor me encontrou
G
Quando eu nem percebi
Am
...
Hoje eu posso dizer
G
Nada é como antes foi
Am
Meu caminho é seguro
F
Porque sigo o Senhor
...
Tua voz me conduz
Am
Eu escolho pra sempre
F
Caminhar com Jesus

[Ponte] 🔥 (parte de pular)
Am
Mais de Ti eu quero
G
Mais do Teu poder
...
Do Teu amor sem fim`
  ...
  {
    cantor: "Adhemar de Campod",
    nome: "Grande é o Senhor",
    cifra: `🎵 Grande é o Senhor
...
Sobre toda terra e Céus`
  ...
  cifra: `🎵 Jesus em Tua Presença (Tom: E)
...
{
  nome: "Medley Festa – Tua Presença Vale Mais",
  cifra: `🎵 Medley Festa – Tua Presença Vale Mais
Autores: Pietro & Matheus
Tom Principal: E

[Parte 1 – Tua Presença]
E
Não há nada igual
Não há nada melhor
A
...
E
Essa é a boa parte que nunca será tirada

[Parte 6 – Só Quero a Ti]
E
Só quero a Ti
C#m
Nada mais, nada mais
...
[Parte Final – Tua Presença Vale Mais]
E
Maravilhoso, Admirável
C#m
Tão sublime, Glorioso
A
Tua presença é mais desejável
E
Do que o ouro
B
...
const lista = document.getElementById("lista-louvores");
const cifraView = document.getElementById("cifra-view");
const cifraTexto = document.getElementById("cifra-texto");
...
function renderLouvores(filtro = "") {
  lista.innerHTML = "";
  louvores
    .filter(l => l.nome.toLowerCase().includes(filtro))
    .forEach(louvor => {
      const div = document.createElement("div");
      div.className = "louvor";
      div.textContent = louvor.nome;
      div.onclick = () => abrirCifra(louvor);
      lista.appendChild(div);
    });
}

function abrirCifra(louvor) {
  lista.classList.add("hidden");
  cifraView.classList.remove("hidden");
  cifraTexto.textContent = louvor.cifra;
}

voltar.onclick = () => {
  cifraView.classList.add("hidden");
...
whatsapp.onclick = () => {
  ...
  const texto = encodeURIComponent(cifraTexto.textContent);
  window.open(`https://wa.me/${telefone}?text=${texto}`, "_blank");
};

search.oninput = e => renderLouvores(e.target.value.toLowerCase());
